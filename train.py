...
parser.add_argument('--experiment_id', type=int, default=0, help='sequence id for the experiments you prepare to run')
...
parser.add_argument('--freeze_encoder', type=int, default=0, help="freeze encoder weights during training")
parser.add_argument('--fine_tune', type=str, default=None, help='specific labels id to be fine tuned')
parser.add_argument('--inst_norm', type=int, default=0, help='use conditional instance normalization in your model')
...
parser.add_argument('--checkpoint_steps', type=int, default=500, help='number of batches in between two checkpoints')
parser.add_argument('--flip_labels', type=int, default=None, help='whether flip training data labels or not, in fine tuning')
